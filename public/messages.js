document.addEventListener("DOMContentLoaded", () => {
   ...
   // Update your init() function to handle authentication errors
function init() {
    ...
    // Updated setupUserPresence function with better error handling
function setupUserPresence(user) {
   ...
   // Updated createConversation function with better error handling
