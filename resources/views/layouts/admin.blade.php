...
<body class="bg-gray-100 min-h-screen">
    <div class="flex">
        ...
        <div class="w-64 bg-gray-800 text-white min-h-screen p-4">
            ...
            <nav>
                <a href="{{ url('/admin/dashboard') }}" class="block py-2 px-4 rounded hover:bg-gray-700 mb-1">Dashboard</a>
                <a href="{{ route('/admin/posts') }}" class="block py-2 px-4 rounded hover:bg-gray-700 mb-1">Posts</a>
                <a href="{{ url('/pages') }}" class="block py-2 px-4 rounded hover:bg-gray-700 mb-1">Pages</a>
