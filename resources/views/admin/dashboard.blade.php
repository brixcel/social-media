...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <a href="{{ url('posts') }}" class="text-blue-500 hover:underline mt-2 inline-block">Manage Posts</a>
    </div>
    
    <div class="bg-white rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold mb-2">Pages</h3>
        <p class="text-3xl font-bold">{{ $pagesCount ?? 0 }}</p>
        <a href="{{ url('pages') }}" class="text-blue-500 hover:underline mt-2 inline-block">Manage Pages</a>
    </div>
